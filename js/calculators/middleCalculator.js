...
export class MiddleCalculator {
    static initialize() {
        // Show calculator options when Calculate button is clicked
        const calculateButton = document.getElementById('calculate-middle');
        if (calculateButton) {
    ...
    static showCalculatorOptions() {
        const calculatorDiv = document.getElementById('middle-calculator-options');
        if (!calculatorDiv) return;

        calculatorDiv.innerHTML = `
            <div class="calculator-options">
                <h3>Options for Middle</h3>
                <div class="option-item" onclick="showCalculator('middle-rom')">
                    <span>ROM</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-arthroplasty')">
                    <span>Arthroplasty</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-sensory')">
                    <span>Sensory</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-amputation')">
                    <span>Amputation</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-synovial')">
                    <span>Synovial Hypertrophy</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-lateral')">
                    <span>Lateral Deviation</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-rotation')">
                    <span>Digit Rotation Deformity</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-subluxation')">
                    <span>Persistent Joint Subluxation/Dislocation</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-instability')">
                    <span>Joint Passive Mediolateral Instability</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-tightness')">
                    <span>Intrinsic Tightness</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-tenosynovitis')">
                    <span>Constrictive Tenosynovitis</span>
                </div>
                <div class="option-item" onclick="showCalculator('middle-tendon')">
    ...
    static calculateROM() {
        this.updateMiddleImpairment();
        this.updateTotalImpairment();
    }

    static updateMiddleImpairment() {
        // Calculate DIP Joint
        const dipFlexionInput = document.getElementById('middle-dip-flexion');
        const dipExtensionInput = document.getElementById('middle-dip-extension');
        const dipAnkylosisInput = document.getElementById('middle-dip-ankylosis');
        const dipFlexionImpOutput = document.getElementById('middle-dip-flexion-imp');
        const dipExtensionImpOutput = document.getElementById('middle-dip-extension-imp');
        const dipAnkylosisImpOutput = document.getElementById('middle-dip-ankylosis-imp');
        const dipImpOutput = document.getElementById('middle-dip-imp');
        ...
        // Calculate PIP Joint
        const pipFlexionInput = document.getElementById('middle-pip-flexion');
        const pipExtensionInput = document.getElementById('middle-pip-extension');
        const pipAnkylosisInput = document.getElementById('middle-pip-ankylosis');
        const pipFlexionImpOutput = document.getElementById('middle-pip-flexion-imp');
        const pipExtensionImpOutput = document.getElementById('middle-pip-extension-imp');
        const pipAnkylosisImpOutput = document.getElementById('middle-pip-ankylosis-imp');
        const pipImpOutput = document.getElementById('middle-pip-imp');
        ...
        // Calculate MP Joint
        const mpFlexionInput = document.getElementById('middle-mp-flexion');
        const mpExtensionInput = document.getElementById('middle-mp-extension');
        const mpAnkylosisInput = document.getElementById('middle-mp-ankylosis');
        const mpFlexionImpOutput = document.getElementById('middle-mp-flexion-imp');
        const mpExtensionImpOutput = document.getElementById('middle-mp-extension-imp');
        const mpAnkylosisImpOutput = document.getElementById('middle-mp-ankylosis-imp');
        const mpImpOutput = document.getElementById('middle-mp-imp');
        ...
        // Update total
        const totalElement = document.getElementById('middle-rom-total');
        if (totalElement) {
